      ...
      <div className="container mx-auto px-[3%] lg:px-[7%] py-8">
        ...
        <div className="flex flex-wrap gap-y-4 items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">
              Manage your {categoryName.toLowerCase()} portfolio
            </p>
          </div>
          <Link href={`/admin/projects/${category}/new`}>
            <Button size="lg">
              <Plus className="w-5 h-5 mr-2" />
              Add New Project
            </Button>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4 opacity-0 group-hover:opacity-100 transition-opacity">
                    <div className="flex gap-2">
                      <button
                        onClick={() =>
                          window.open(
                            `https://giagency.vercel.app/services/${category}/${project.slug}`,
                            "_blank"
                          )
                        }
                      ...
                      <button
                        onClick={() =>
                          router.push(
                            `/admin/projects/${category}/${project.slug}/edit`
                          )
                        }
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem
                          onClick={() =>
                            window.open(
                              `https://ibetaagency.vercel.app/services/${category}/${project.slug}`,
                              "_blank"
                            )
                          }
                        >
